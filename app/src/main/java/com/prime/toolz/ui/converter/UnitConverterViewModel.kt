...
import com.prime.toolz.common.compose.SnackDataChannel
import com.prime.toolz.common.compose.send
import com.prime.toolz.core.converter.Converter
import com.prime.toolz.core.converter.Unet
import com.prime.toolz.core.converter.UnitConverter
...
class UnitConverterViewModel @Inject constructor(
    ...
    fun swap() {
        ...
        toUnit(to)
        viewModelScope.launch {
            channel?.send(message = "Swapping units!!")
        }
    }
